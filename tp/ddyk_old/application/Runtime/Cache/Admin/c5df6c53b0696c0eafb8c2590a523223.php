...
<body>
  ...
  <div class="crumbs-nav">
    <span class="layui-breadcrumb" lay-separator=">" style="height: 100px;">
      ...
      <a href="<?php echo U('Admin/index');?>" class="link"><cite>管理员列表</cite></a>
    </span>
  </div>
  <!--内容  -->
  <div class="manage-btn-wrapper">
    <form action="">
      <div class="handle-wrap layui-left">
        ...
        <form action="<?php echo U('Admin/index');?>" method="get">
          <input type="text" name="search" class="search" placeholder="请输入用户名称查找">
    ...
    <div class="layui-right">
      <a href="<?php echo U('Admin/add');?>" class="layui-btn layui-btn-sm layui-btn-normal">
        <i class="layui-icon">&#xe654;</i>
        添加管理员
      </a>
    </div>
