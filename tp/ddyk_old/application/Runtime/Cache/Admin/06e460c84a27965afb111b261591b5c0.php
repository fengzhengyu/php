...
<body>
  ...
  <div class="crumbs-nav">
    <span class="layui-breadcrumb" lay-separator=">" style="height: 100px;">
      ...
      <a href="<?php echo U('Admin/roleList');?>" class="link"><cite>角色列表</cite></a>
    </span>
  </div>
  <!--内容  -->
  <div class="manage-btn-wrapper">
    <form action="">
      <div class="handle-wrap layui-left">
        <!-- 筛选条件 -->
        <form action="<?php echo U('Admin/Goods/type');?>" method="get">
          <input type="text" name="" id="" class="search" placeholder="请输入商品名称查找">
    ...
    <div class="layui-right">
      <a href="<?php echo U('Admin/addRole');?>" class="layui-btn layui-btn-sm layui-btn-normal">
        <i class="layui-icon">&#xe654;</i>
        添加角色
      </a>
    </div>
