...
<body>
  ...
  <div class="crumbs-nav">
    <span class="layui-breadcrumb" lay-separator=">" style="height: 100px;">
      ...
      <a href="<?php echo U('User/index');?>" class="link"><cite>用户列表</cite></a>
    </span>
  </div>
  <!--内容  -->
  <div class="manage-btn-wrapper">
    ...
    <div class="layui-right">
      <a href="<?php echo U('User/add');?>" class="layui-btn layui-btn-sm layui-btn-normal">
        <i class="layui-icon">&#xe654;</i>
        添加用户
      </a>
    </div>
  ...
  <table class="layui-table">
    ...
    <tbody>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td>
              <?php echo ($vo['user_pass']); ?>
            </td>
            <td>
               <?php if($vo['user_status'] == 1): ?>开启
                 <?php else: ?>
                 关闭<?php endif; ?>
              </td>
          <td>

            <a href="<?php echo U('User/add',array('user_id'=>$vo['user_id']));?>"
